...
#vacc_interval = 0.1  #days16
#stop_interval = 30.0  #days714
...
data_file = 'BR07_CA09_Norm' + str(random.getrandbits(11)) + '.txt'
...
if (vaccine == "monovalent"):
    ...
    V1 = func.Antigen("V1", ag_initial, strain2)#BR07
    V2 = func.Antigen("V2", 0, strain3)#SC18
